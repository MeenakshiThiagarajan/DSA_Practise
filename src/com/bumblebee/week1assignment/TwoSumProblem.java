...
1) Did I understand the problem? Yes or No !!
        ...
        *    What is the input(s)? --> In this program the input will be an integer array and a target integer value
        *    What is the expected output? --> Integer array with index of numbers whose sum gives the target value
...
2) Test data set
        ...
        *    In this problem
             -----> Positive Cases - {2,4,6,8,12} 10
             -----> Negative Cases - {2,4,6,8} 10,  {-1,1} 4 , {} 1
             -----> Edge Cases - {7,3,5,5,7} 10, {3,5,7} 10

3) Do I know how to solve it?
        * Yes - Great, is there an alternate? -> Yes
        * No - Can I break down the problem into sub problems? -> Let's Assume,
        *       1. Use two for loops - Outer loop for first number and inner loop to iterate the array for the second numbe
        *  		2. condition to check the sum of two numbers with target value
        *  		3. If condition satisfies store the values of i and j in array
        *       4. Start the inner loop from i ie., j=i to validate the edge cases
